...
public class ClassroomCreateLead {
	...
	
	{
		...
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Sistla");
		driver.findElement(By.id("createLeadForm_lastName")).sendKeys("Harish");
	    ...
	    marketcampid.selectByVisibleText("Automobile");
	    
	    
	    WebElement ownership = driver.findElement(By.name("ownershipEnumId"));
	    Select ownershipid = new Select(ownership);
	    ownershipid.selectByValue("OWN_CCORP");
